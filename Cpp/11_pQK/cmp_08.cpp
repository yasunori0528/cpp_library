...
int main(){
    ...
    Bint upper_bound_of_search_range = power(10,72-12,100);

    int64_t imax = power(10,12);
    int amax = 2; //256;
    for (int64_t i = 7/*22199796329*/; i < imax; i+=2){
        int ii = i%210;
